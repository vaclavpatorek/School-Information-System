...
namespace SchoolIS.App.Platforms.Windows;
...
public static class CursorExtensions {
  public static void SetCustomCursor(this VisualElement visualElement, CursorIcon cursor,
    ...
    void ViewOnPointerExited(object sender, PointerRoutedEventArgs e) {
      view.ChangeCursor(
        InputCursor.CreateFromCoreCursor(new CoreCursor(GetCursor(CursorIcon.Arrow), 1)));
    }
  ...
  static void ChangeCursor(this UIElement uiElement, InputCursor cursor) {
    ...
    type.InvokeMember("ProtectedCursor",
      ...
      BindingFlags.Instance, null, uiElement, new object[] { cursor });
  }
