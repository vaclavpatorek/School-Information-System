...
namespace SchoolIS.DAL.Migrations
{
    ...
    [Migration("20240506185338_ReplaceEnrollsAndTeachesWithHasStudentTable")]
    partial class ReplaceEnrollsAndTeachesWithHasStudentTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolIS.DAL.Entities.HasSubjectEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SchoolIS.DAL.Entities.HasSubjectEntity", b =>
                {
                    ...
                    b.HasOne("SchoolIS.DAL.Entities.UserEntity", "User")
                        .WithMany("Subjects")
